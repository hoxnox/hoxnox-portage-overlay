...
IUSE_LIRC_DEVICES_DIRECT="
	...
	uirt2_raw usb_irtoy usb_uirt_raw usbx wpc8769l zotac"
...
NO_KMOD_BUILT_FOR_DEV="
	...
	tuxbox udp uirt2 uirt2_raw usb_irtoy usb_uirt_raw usbx"
...
src_prepare() {
	...
	use lirc_devices_remote_wonder_plus && epatch "${FILESDIR}"/lirc-0.8.3_pre1-remotewonderplus.patch
        ...
        use lirc_devices_usb_irtoy && epatch "${FILESDIR}"/0001-Add-driver-for-USB-Infrared-Toy-in-sample-mode.patch && epatch "${FILESDIR}"/0002-Add-USB-Infrared-Toy-driver-to-setup-system.patch
	...
	use lirc_devices_zotac && epatch "${FILESDIR}"/${P}-add-zotac-support.patch
	# Use fixed font
